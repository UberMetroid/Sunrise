...
```bash
# 1. Navigate to the Thanatonaut directory
cd Thanatonaut
...
|---|---|---|
| `THANATONAUT_BIND_ADDRESS` | `0.0.0.0` | Listening interface (`0.0.0.0` listens across all LAN/WAN) |
| `THANATONAUT_PORT` | `7777` | TCP port for BAP protocol telemetry |
