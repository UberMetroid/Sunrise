...
// Title: Legacy Destiny 2 Depot Downloader & Vault Provisioner
// Plain English: Downloads and configures the legacy Season of Arrivals Destiny 2 game depots.
...
impl DepotDownloader {
    ...
    pub fn print_manual_instructions(target_dir: &Path) {
        ...
        println!("1. Download Core Game Binaries (Depot {}):", DEPOT_CORE_ID);
        println!(
        ...
        println!("2. Download Package Assets (Depot {}):", DEPOT_PACKAGES_ID);
        println!(
            "   \x1b[1;33mDepotDownloader -app {} -depot {} -manifest {} -dir \"{}\" -username <STEAM_USER>\x1b[0m\n",
    ...
    pub fn run_interactive_download(target_dir: &Path) -> Result<()> {
        ...
        println!("Steam account owning Destiny 2 is required for Steam authentication.\n");

        print!("  \x1b[1;33m[?]\x1b[0m \x1b[1mEnter Steam Username (or press Enter to skip)\x1b[0m: ");
        ...
        log_info("DEPOT 1/2", "Downloading core game binaries...");
        ...
        // 2. Download Packages
        log_info("DEPOT 2/2", "Downloading package content archives...");
        let _ = Command::new(&exe)
            .args(["-app", &APP_ID.to_string()])
